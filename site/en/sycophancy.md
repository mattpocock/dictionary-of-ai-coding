...
Confidently agreeable [model](/en/model) output. Caused by [training](/en/training): the model was shaped to favor answers humans liked, and humans tend to like agreement more than they like being told they're wrong. So the model learned that agreeing is rewarded — even when the agreement is incorrect.
...
"Classic sycophancy — it agreed first because you sounded confident, then caved because you sounded doubtful. The plan's quality didn't change, your tone did. [Clear](/en/clearing) and re-ask without signalling either way."

<div style="text-align:center;margin-top:2rem">
  <a href="/th/sycophancy" class="VPLink">Read in ไทย →</a>
</div>
