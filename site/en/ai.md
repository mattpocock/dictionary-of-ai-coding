...
A moving label, not a technology. "AI" doesn't name a fixed thing the way [model](/en/model) or [token](/en/token) does — it points at whatever computers can newly, impressively do. Right now it points at large language models. It has pointed at very different things before:
...
<div style="text-align:center;margin-top:2rem">
  <a href="/th/ai" class="VPLink">Read in ไทย →</a>
</div>
