...
A working pattern where the user accepts the [agent](/en/agent)'s code without [human review](/en/human-review). The diff is treated as opaque — what matters is whether the program behaves, not what's inside. [Automated review](/en/automated-review) and [automated checks](/en/automated-check) may still run; vibe coding is silent on both.
...
<div style="text-align:center;margin-top:2rem">
  <a href="/th/vibe-coding" class="VPLink">Read in ไทย →</a>
</div>
