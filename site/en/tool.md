...
A function the [harness](/en/harness) exposes for the [agent](/en/agent) to call — Read, Write, Bash, Search. Tools are how an agent perceives and acts on the [environment](/en/environment): it can't see the environment except through [tool results](/en/tool-result), and can't change it except through [tool calls](/en/tool-call). Each tool call costs an extra [model provider request](/en/model-provider-request), since the result has to go back to the model before it can decide what to do next.
...
<div style="text-align:center;margin-top:2rem">
  <a href="/th/tool" class="VPLink">Read in ไทย →</a>
</div>
