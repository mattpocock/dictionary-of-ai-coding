...
หน่วยย่อยที่สุด (atomic unit) ที่ [model](/th/model) ใช้ในการอ่านและเขียน มีขนาดใกล้เคียงกับคำหนึ่งคำแต่ไม่ตรงกันเป๊ะ โดยคำทั่วไปที่พบบ่อยจะนับเป็นหนึ่ง token ส่วนคำที่พบยากหรือคำที่มีความยาวจะถูกหั่นย่อยออกเป็นหลายโทเค็น ทั้งขนาดของ [context window](/th/context-window), ค่าใช้จ่าย และความหน่วง (latency) ล้วนถูกคำนวณนับด้วยหน่วยโทเค็นทั้งสิ้น

ข้อความจะถูกแปลงสภาพให้กลายเป็นโทเค็นผ่านเครื่องมือที่เรียกว่า tokenizer ซึ่งภายในบรรจุคลังคำศัพท์ (vocabulary) ขนาดหลายหมื่นชิ้นส่วนที่ถูกกำหนดไว้ตายตัวและเรียนรู้มาตั้งแต่ก่อนขั้นตอน [training](/th/training) (การฝึกฝน) ทำหน้าที่หั่นข้อมูลนำเข้าใดๆ ให้กลายเป็นลำดับของชิ้นส่วนคำศัพท์เหล่านั้น โมเดลไม่มีวันมองเห็นตัวอักษรหรือคำโดดๆ ข้อความทุกชิ้นจะถูกแปลงเป็นโทเค็นในขาเข้า และกระบวนการ [next-token prediction](/th/next-token-prediction) ก็จะผลิตผลลัพธ์ออกมาทีละหนึ่งโทเค็นในขาออกเช่นกัน
...
<div style="text-align:center;margin-top:2rem">
  <a href="/en/token" class="VPLink">Read in English →</a>
</div>
