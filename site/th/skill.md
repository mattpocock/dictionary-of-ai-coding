...
ชุดคู่มือขั้นตอนการปฏิบัติงานและทรัพยากรข้อมูลที่ถูกจัดเก็บและรวมมัดเข้าไว้ด้วยกันเป็นหนึ่งแพ็กเกจสำเร็จรูปเพื่อใช้ในการสอนและสั่งการให้ระบบสามารถดำเนินภารกิจประเภทใดประเภทหนึ่งได้อย่างเชี่ยวชาญ (teachable capability) โดยชุดข้อมูลคำสั่งตัวเต็มจะถูกกั้นแยกและจัดเก็บไว้บนสภาพแวดล้อมระบบ ([environment](/th/environment)) นอกพื้นที่หน้าต่างบริบท และจะยอมเปิดโหลดดึงข้อมูลเข้าสู่หน้าต่างบริบท ([context window](/th/context-window)) ก็ต่อเมื่อมีเส้นสายข้อมูลจากตัวชี้พิกัดบริบท ([context pointer](/th/context-pointer)) วิ่งมาสั่งเรียกใช้งานในยามที่เนื้องานตรงหน้าวิ่งเข้าล็อกเงื่อนไข ถือเป็นยูนิตองค์ประกอบหลักชิ้นสำคัญที่ระบบควบคุม ([harness](/th/harness)) นำมาใช้ซัพพอร์ตกลยุทธ์ค่อย ๆ เปิดเผยข้อมูล ([progressive disclosure](/th/progressive-disclosure))
...
- ชุดไฟล์สคริปต์เสริมคำสั่งสำเร็จรูป (สิทธิ์ตัวเลือกเพิ่มเติม) ที่เปิดโอกาสให้ตัว [agent](/th/agent) สามารถส่งคำสั่งคอมมานด์รันระบบสั่งทำงานได้ทันที
