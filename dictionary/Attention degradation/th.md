...
สภาวะที่เกิดขึ้นในยามที่ [session](./Session.md) บทสนทนาเริ่มขยายตัวลากยาวขึ้น ส่งผลให้โควตาพลังงานความสนใจ ([attention budget](./Attention%20budget.md)) ของแต่ละ [token](./Token.md) ถูกรุมเฉือนส่วนแบ่งกระจายไปให้แก่ตัวหารและคู่แข่งเกิดใหม่จำนวนมาก สัญญาณความเชื่อมโยงของ [คู่ความสัมพันธ์ที่มีคุณค่า](./Attention%20relationship.md) ต่องานจะดิ่งวูบหล่นลง และโดนสัญญาณรบกวนจากข้อความ[บริบท](./Context.md)ขยะรอบทิศทางรุมตะโกนข่มเบียดบังจนจมหาย รันบนฐานของ [model](./Model.md) ตัวเดิม ค่าพารามิเตอร์ ([parameters](./Parameters.md)) ชุดเดิมทุกประการ — มีเพียงตัวหารที่เข้ามารุมแย่งส่วนแบ่งอาหารบนจานคณิตศาสตร์ใบเดิมที่มีขนาดเท่าเดิมเท่านั้น นี่คือกลไกหลักหลังบ้านที่เป็นต้นตอของปรากฏการณ์สลับขั้วระหว่างโซนฉลาดและ [โซนเอ๋อ](./Smart%20zone.md) (smart zone / dumb zone effect)
