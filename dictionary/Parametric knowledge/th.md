...
"เพราะเทคโนโลยี React มีข้อมูลหนาแน่นอยู่ในความรู้ในพารามิเตอร์ครับ มีตัวอย่างให้มันเรียนรู้มาเป็นล้าน ๆ ชิ้นในดาต้าเซ็ต แต่ชุดซอฟต์แวร์ SDK ของบริษัทคุณไม่ได้อยู่ข้างในนั้น โมเดลเลยต้องใช้วิธีเดาสุ่มรูปทรงที่น่าจะเป็นขึ้นมาแทน ให้รีบเอาคู่มือการใช้งาน SDK โหลดเข้าไปใน [บริบท](./Context.md) ด่วนเลยครับ"
